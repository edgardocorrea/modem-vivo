...
if (-not $args) {
    Write-Host ''
    Write-Host 'Instalador Automático - Modem VIVO Unlock Tool' -ForegroundColor Cyan
...
& {
    ...
    Write-Host "│ 3. O iniciar.bat verificará tudo automaticamente        │" -ForegroundColor Yellow
    Write-Host "└─────────────────────────────────────────────────────────┘" -ForegroundColor Yellow
    Write-Host ""
